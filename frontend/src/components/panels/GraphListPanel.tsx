...
import { Search, BrainCircuit, TrendingUp, Clock, Plus } from 'lucide-react';
...
export interface GraphListPanelProps {
  activeGraphs: string[];
...
/**
 * GraphListPanel Component
 *
 * Displays a list of available graphs with filtering and creation capabilities.
 * Refactored from GraphSidebar to fit within VSCodeLayout left panel.
 */
export default function GraphListPanel({ activeGraphs, onToggleGraph }: GraphListPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: theme.spacing.sm }}>
        {loading && (
          <div style={{ padding: theme.spacing.md, textAlign: 'center', color: theme.colors.text.secondary, fontSize: '12px' }}>
            Loading...
          </div>
        )}

        {error && (
          <div style={{ padding: theme.spacing.md, textAlign: 'center', color: '#ef4444', fontSize: '12px' }}>
            Error: {error.message}
          </div>
        )}
        ...
        <>
          ...
          >
            ...
            <div style={{ marginBottom: theme.spacing.md }}>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 500, color: theme.colors.text.secondary, marginBottom: theme.spacing.xs }}>
                Name *
              </label>
              <input
                type="text"
